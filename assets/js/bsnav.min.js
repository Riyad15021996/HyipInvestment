! function(n) { "use strict"; var a = { initialize: function() { this.event(), this.toggler(), this.dropdown(), this.sideMenu(), this.navbarSticky(), this.scrollspy() }, event: function() {}, toggler: function() { n(".navbar-toggler").each(function() { var a = n(this);
                ...
                s = a.outerHeight(),
                i = [];
            a.length && (a.find("[data-scrollspy]").each(function(a) { i.push(n(this).data("scrollspy")) }), n(window).scroll(function() {! function() { if (!a.hasClass("spying")) { var e = n(window).scrollTop();
                        i.map(function(i, o) { var t = n("#" + i).offset().top - s,
                                l = t + n("#" + i).outerHeight();
                            e >= t && e <= l && (a.find(".nav-item").removeClass("active"), n("[data-scrollspy=" + i + "]").parent().addClass("active")) }) } }() }), $("body").on("click", "a[data-scrollspy]", function(i) { i.preventDefault(), a.addClass("spying"); var e = n(this).data("scrollspy");
    ...
    n(document).ready(function() { a.initialize() }), n(window).on("load", function() { a.mobileMenu() }) }(jQuery);